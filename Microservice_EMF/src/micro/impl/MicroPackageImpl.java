...
public class MicroPackageImpl extends EPackageImpl implements MicroPackage {
	 ...
	 * @generated
	 */
	public EReference getModel_AggregateService() {
	...
	public void createPackageContents() {
		...
		createEReference(modelEClass, MODEL__AGGREGATE_SERVICE);
	...
	public void initializePackageContents() {
		...
		initEReference(getModel_AggregateService(), this.getAggregateService(), this.getAggregateService_Models(), "aggregateService", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getAggregateService_Models(), this.getModel(), this.getModel_AggregateService(), "models", null, 1, -1, AggregateService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getOperation_Model(), this.getModel(), null, "model", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

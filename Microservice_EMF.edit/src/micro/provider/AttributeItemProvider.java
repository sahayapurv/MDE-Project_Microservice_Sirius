...
/**
 * This is the item provider adapter for a {@link micro.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MicroPackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIsManyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isMany_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isMany_feature", "_UI_Attribute_type"),
				 MicroPackage.Literals.ATTRIBUTE__IS_MANY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MicroPackage.Literals.ATTRIBUTE__IS_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addIsGeneratedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isGenerated_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isGenerated_feature", "_UI_Attribute_type"),
				 MicroPackage.Literals.ATTRIBUTE__IS_GENERATED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public ResourceLocator getResourceLocator() {
		return MicroArchEditPlugin.INSTANCE;
	}

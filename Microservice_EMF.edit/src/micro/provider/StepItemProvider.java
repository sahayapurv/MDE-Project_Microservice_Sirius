...
/**
 * This is the item provider adapter for a {@link micro.Step} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StepItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_commands_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_commands_feature", "_UI_Step_type"),
				 MicroPackage.Literals.STEP__COMMANDS,
				 true,
				 false,
				 true,
				 null,

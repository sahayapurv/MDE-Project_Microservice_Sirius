...
/**
 * This is the item provider adapter for a {@link micro.ReferenceAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceAttribute_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceAttribute_type_feature", "_UI_ReferenceAttribute_type"),
				 MicroPackage.Literals.REFERENCE_ATTRIBUTE__TYPE,
				 true,
				 false,
				 true,
				 null,
